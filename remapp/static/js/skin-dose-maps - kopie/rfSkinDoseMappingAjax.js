    ...
    $.ajax({
        ...
        success: function( json ) {
            ...
            if (isCanvasSupported()) {
                ...
                skinDoseMapObj.initialise(json.skin_map, json.width, json.height, json.phantom_flat_dist, json.phantom_curved_dist, json.phantom_head_height, json.phantom_head_circumference);
                ...
                if (skinDoseMapObj.maxDose !== 0 && isFinite(skinDoseMapObj.maxDose)) {
                    ...
                    if (show3dSkinDoseMap) {
                        ...
                        skinDoseMap3dObj.initialise(json.skin_map, json.phantom_flat_dist, json.phantom_curved_dist, json.phantom_height, json.phantom_depth / 2, json.phantom_head_height, json.phantom_head_circumference, json.skin_map_array);
                        ...
                        skinDoseMap3dHUDObj.phantomDimensionsLabel = json.phantom_height + json.phantom_head_height + "x" + json.phantom_width + "x" + json.phantom_depth;
