...
function skinDoseMap3dObject(skinDoseMap3dCanvasName, colourScaleName) {
    ...
    this.draw = function () {
        ...
        for (i = 0; i < torsoStart; i++) {
            for (j = 0; j < _this.phantomHeadCircumference; j++) {
...
*/
        ...
        headData = new Uint8Array(_this.phantomHeadCircumference*_this.phantomHeadHeight*4)
        ...
        dataTextureHead = new THREE.DataTexture(headData, _this.phantomHeadCircumference, _this.phantomHeadHeight, THREE.RGBAFormat)
        ...
        geometry = new THREE.CylinderGeometry(_this.phantomHeadCircumference/(2*Math.PI), _this.phantomHeadCircumference/(2*Math.PI), _this.phantomHeadHeight, 57, 1, true, Math.PI, 2*Math.PI );
        mesh = new THREE.Mesh(geometry);
