__version__ = "0.10.0b2"                   # Actual version number
__docs_version__ = "0.10.0b2-docs"              # Should match the branch readthedocs will build against - tag + '-docs'
...
__repo_branch__ = "0.10.0b2"            # __repo_branch__feeds into construction of link in netdicom-orthanc-config doc
