...
def rf_detail_view(request, pk=None):
    ...
    import numpy as np
    from remapp.models import HighDoseMetricAlertSettings, SkinDoseMapCalcSettings, SkinDoseMapResults
    from django.core.exceptions import ObjectDoesNotExist
    ...
    try:
        skinresult = SkinDoseMapResults.objects.get(general_study_module_attributes=study)
        skin_result_exists = 1
    except ObjectDoesNotExist:
        messages.error(request, 'That skin dose result was not found')
        skin_result_exists = 0
    ...
    if skin_result_exists:
        context = {'generalstudymoduleattr': study, 'admin': admin,
         'openskinresult': skinresult,
