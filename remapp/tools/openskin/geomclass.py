...
class Phantom_3:
    ...
    def __init__(self, origin, scale=1, mass=73.2, height=178.6, patPos="HFS"):
        ...
        headHeight = round(20 * height / refHeight)
        headCircumference = 58
        radiusHead = headCircumference/(2 * math.pi)
        ...
        while not it.finished:
            ...
            angleStepHead = 2*math.pi / headCircumference
            zOffset = -origin[2]
            ...
            elif row_index < headCircumference and col_index <= self.phantom_head_height:#q1
                myY = (col_index) * patPosY
                myX = radiusHead * math.cos(angleStepHead * (row_index )) - (roundFlat / 2.) + round(roundFlat / 2., 0)
                myZ = zOffset + radiusHead * (math.sin(angleStepHead * row_index)  ) * patPosZ + self.phantom_depth/2
