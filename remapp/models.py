...
class SkinDoseMapResults(models.Model):
    ...
    #phantom_type = models.CharField(max_length=16)
    general_study_module_attributes = models.ForeignKey(GeneralStudyModuleAttr, on_delete=models.CASCADE)
    phantom_width = models.DecimalField(max_digits=16, decimal_places=2, blank=True, null=True)
    phantom_height = models.DecimalField(max_digits=16, decimal_places=2, blank=True, null=True)
    phantom_depth = models.DecimalField(max_digits=16, decimal_places=2, blank=True, null=True)
   # phantom_dimensions = models.
    patient_mass = models.DecimalField(max_digits=16, decimal_places=4, blank=True, null=True)
    ...
    #DAP_perc_missed_phantom = models.DecimalField(max_digits=16, decimal_places=4);
    hit_fraction = models.DecimalField(max_digits=16, decimal_places=4, null=True, blank=True)
    skin_map_version = models.CharField(max_length=16, null=True, blank=True)
    dap_percentage_contributed = models.DecimalField(max_digits=16, decimal_places=4, null=True, blank=True)
